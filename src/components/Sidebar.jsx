  ...
  return (
    <>
      ...
      <nav
        ...
        }  fixed lg:translate-x-0 bg-[#0D0E32] lg:relative z-50 w-[MIN(100%,100px)] overflow-y-scroll min-w-[220px] shadow-2xl flex flex-col min-h-screen py-4 max-h-screen transition-all duration-300`}
      >
